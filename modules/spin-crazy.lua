...
function module.start()
    ...
    module.conn = game:GetService("RunService").Heartbeat:Connect(function() char:WaitForChild("HumanoidRootPart").CFrame = char.HumanoidRootPart.CFrame * CFrame.Angles(0, math.rad(30), 0) end)
end
