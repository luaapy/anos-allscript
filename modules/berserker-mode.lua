...
function module.start()
    ...
    module.conn = game:GetService("RunService").Heartbeat:Connect(function() if char:WaitForChild("Humanoid").Health < char.Humanoid.MaxHealth * 0.3 then char.Humanoid.WalkSpeed = 30 else char.Humanoid.WalkSpeed = 16 end end)
end
