...
function module.start()
    ...
    local part = Instance.new("Part") part.Size = Vector3.new(15, 0.5, 15) part.Anchored = true part.CanCollide = false part.Material = Enum.Material.Neon part.Color = Color3.fromRGB(255, 100, 0) part.Parent = workspace part.Position = char:WaitForChild("HumanoidRootPart").Position - Vector3.new(0, 3, 0) module.part  = part
end
