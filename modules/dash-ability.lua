...
function module.start()
    ...
    local UIS = game:GetService("UserInputService") module.conn = UIS.InputBegan:Connect(function(input) if input.KeyCode == Enum.KeyCode.Q then char:WaitForChild("HumanoidRootPart").CFrame = char.HumanoidRootPart.CFrame + char.HumanoidRootPart.CFrame.LookVector * 20 end end)
end
