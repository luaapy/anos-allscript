...
function module.start()
    ...
    local UIS = game:GetService("UserInputService") module.conn = UIS.InputBegan:Connect(function(input) if input.KeyCode == Enum.KeyCode.E then char:WaitForChild("HumanoidRootPart").CFrame = char.HumanoidRootPart.CFrame + char.HumanoidRootPart.CFrame.LookVector * 15 end end)
end
