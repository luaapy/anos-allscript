...
function module.start()
    ...
    module.conn = game:GetService("RunService").Heartbeat:Connect(function() char:WaitForChild("HumanoidRootPart").CFrame = char.HumanoidRootPart.CFrame - char.HumanoidRootPart.CFrame.LookVector * 0.3 end)
end
